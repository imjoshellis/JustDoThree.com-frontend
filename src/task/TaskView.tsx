    ...
    >
      <form className='flex truncate'>
        <input
          ...
          name={'task-' + id}
          className={`check-input rounded border-solid border-2 mt-1 appearance-none p-15 w-1 h-1 relative focus:outline-none transition duration-200 cursor-pointer hover:border-gray-60 ${
            completed
